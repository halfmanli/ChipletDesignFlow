...
parameter_path = str(pathlib.Path(__file__).parent.absolute()) + "/parameter.ini"
...
max_aspect_ratio = 2  # hight / width
# D2D interface
D2D_symmetric = True
D2D_bw_area_density = 631  #  45 um bump pitch for Advanced package, 16 GT/s
D2D_die_edge_bw_density = 658  # 16 GT/s
D2D_latency = 2  # ns
D2D_energy_efficiency = 0.6 # pJ/bit
