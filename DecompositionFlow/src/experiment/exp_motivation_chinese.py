...
def plot():
    ...
    font_path = "/research/Chipletization/tnw+simsun.ttf"
    ...
    ax_1.set_title("(a) 产品出货量为500k", y=0.92, fontsize=18, weight="bold")
    ...
    ax_1.set_xlabel("SoC A划分芯粒数量", fontsize=14)
    ax_1.set_ylabel("SoC B划分芯粒数量", fontsize=14)
    ax_1.set_zlabel("归一化成本")
    ...
    ax_2.set_title("(b) 产品出货量为10M", y=0.92, fontsize=18, weight="bold")
    ...
    fig.legend([dots, stars], ["可重用划分", "最优划分"], loc='lower center', ncol=2, fontsize=12)
