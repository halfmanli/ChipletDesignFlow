...
class Bstree:
    ...
    def parsenode(self, node: Node, ind, x, y, width, height):
        if node == None:
            return
        ind.append(node.ind)
        x.append(node.x)
    ...
    def printTree(self, tree):
        ...
        if tree != None:
            print(tree.ind,
                  ...
                  tree.width,
                  tree.height,
                  tree.parent.ind if tree.parent else None,
                  tree.left.ind if tree.left else None,
                  tree.right.ind if tree.right else None,
                  sep='\t')
